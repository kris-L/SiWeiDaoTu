...
public class PicEightNodeActivity extends BaseActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		baseSetBodyView(R.layout.activity_picture_eight_node, true);
...
//		initData();
	...
	private void initData() {
		...
		nodeData.clear();
		int[] intRandom = GetRandomSequence(9);
...
//		params.width = LayoutParams.FILL_PARENT;
		...
		if (type == 1) {
			...
			dialog_text2_tv.setText("通过[图片导图-8个节点]考试");
