...
public class PicTwelveNodeActivity extends BaseActivity implements
	...
	private ImageView pic_six_node_iv;
	private ImageView pic_seven_node_iv ;
	private ImageView pic_eight_node_iv;
	private ImageView pic_nine_node_iv;
	private ImageView pic_ten_node_iv;
	private ImageView pic_eleven_node_iv ;
	private ImageView pic_twelve_node_iv;
	private ImageView pic_thirteen_node_iv;
	...
	private int totalNode = 13;
	
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		baseSetBodyView(R.layout.activity_picture_twelve_node, true);
...
//		initData();
	...
	private void initViews() {
		...
		pic_six_node_iv = (ImageView) findViewById(R.id.pic_six_node_iv);
		pic_seven_node_iv = (ImageView) findViewById(R.id.pic_seven_node_iv);
		pic_eight_node_iv = (ImageView) findViewById(R.id.pic_eight_node_iv);
		pic_nine_node_iv = (ImageView) findViewById(R.id.pic_nine_node_iv);
		pic_ten_node_iv = (ImageView) findViewById(R.id.pic_ten_node_iv);
		pic_eleven_node_iv = (ImageView) findViewById(R.id.pic_eleven_node_iv);
		pic_twelve_node_iv = (ImageView) findViewById(R.id.pic_twelve_node_iv);
		pic_thirteen_node_iv = (ImageView) findViewById(R.id.pic_thirteen_node_iv);
		...
		imageViewList.add(pic_six_node_iv);
		imageViewList.add(pic_seven_node_iv);
		imageViewList.add(pic_eight_node_iv);
		imageViewList.add(pic_nine_node_iv);
		imageViewList.add(pic_ten_node_iv);
		imageViewList.add(pic_eleven_node_iv);
		imageViewList.add(pic_twelve_node_iv);
		imageViewList.add(pic_thirteen_node_iv);
		...
		pic_six_node_iv.setOnClickListener(this);
		pic_seven_node_iv.setOnClickListener(this);
		pic_eight_node_iv.setOnClickListener(this);
		pic_nine_node_iv.setOnClickListener(this);
		pic_ten_node_iv.setOnClickListener(this);
		pic_eleven_node_iv.setOnClickListener(this);
		pic_twelve_node_iv.setOnClickListener(this);
		pic_thirteen_node_iv.setOnClickListener(this);
	...
	private void initData() {
		...
		nodeData.clear();
		int[] intRandom = GetRandomSequence(totalNode);
	...
	public void onClick(View v) {
		...
		case R.id.pic_thirteen_node_iv:
			if (memoryType == 3) {
				selectNode = 12;
				selectTextView(selectNode);
			}
...
//		params.width = LayoutParams.FILL_PARENT;
		...
		if (type == 1) {
			...
			dialog_text2_tv.setText("通过[图片导图-12个节点]考试");
